...
function ReportView({ certId, product }: { certId: string; product: any }) {
  ...
  return (
    <div className="min-h-[100dvh] md:h-[100dvh] bg-[#e7e7e7] p-1.5 md:p-2 flex justify-center items-start md:items-center overflow-y-auto md:overflow-hidden">
      <div className="w-full max-w-[620px] md:max-w-[940px] md:h-[calc(100dvh-1rem)] bg-[#efefef] border border-[#4f4f4f] p-3 md:p-3 md:flex md:flex-col md:overflow-hidden">
        <div className="flex items-center justify-center gap-2 pb-2 md:pb-1.5 border-b border-[#777]">
          <Diamond className="h-5 w-5 text-[#111]" />
          <h1 className="text-[clamp(20px,4.4vw,46px)] md:text-[29px] lg:text-[31px] leading-none font-black tracking-[0.01em] text-[#111] text-center">GEM IDENTIFICATION REPORT</h1>
        </div>

        <div className="mt-3 md:mt-2 bg-[#0f1418] text-white text-center font-extrabold text-[clamp(14px,4.4vw,42px)] md:text-[22px] lg:text-[24px] leading-[1.28] py-2.5 md:py-2 px-2 md:px-3">
            ...
            <tbody>
              {rows.map((row) => (
                <tr key={row.label} className="border-t border-[#666]">
                  <td className="w-[46%] border-r border-[#666] text-center px-2 md:px-3 py-2.5 md:py-1.5">
                    <div className="text-[clamp(16px,3.8vw,35px)] md:text-[19px] lg:text-[21px] leading-[1.02] font-extrabold whitespace-pre-line text-[#111]">{row.label}</div>
                  </td>
                  <td className="w-[54%] text-center px-2 md:px-3 py-2.5 md:py-1.5">
                    <div className="text-[clamp(16px,4.4vw,40px)] md:text-[20px] lg:text-[22px] leading-[1.05] font-semibold text-[#111] break-words">{row.value}</div>
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        <div className="text-center mt-2 md:mt-1.5 text-[clamp(15px,4.2vw,34px)] md:text-[22px] lg:text-[24px] leading-none font-black tracking-tight text-[#111]">
